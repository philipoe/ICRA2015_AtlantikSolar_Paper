...
\usepackage[backend=bibtex, % <--
  style=ieee,maxnames=10, minnames=10,sorting=none,url=true]{biblatex}
\addbibresource{refs/refs_SolarUAVsURL,refs/refs_PhilippOePapersURL,refs/refs_AllOthers,refs/refs_KAURL}
